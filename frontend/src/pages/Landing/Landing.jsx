...
@media (max-width: 860px) {
  ...
  h1 { font-size: clamp(28px, 8vw, 40px) !important; margin-bottom: 40px !important; }
  ...
  div[style*="padding: 35px"] { padding: 24px !important; }
  div[style*="padding: 50px 40px"] { padding: 30px 24px !important; }
  div[style*="padding: 48px 36px"] { padding: 28px 20px !important; }
  div[style*="padding: 32px"] { padding: 20px !important; }
  section[style*="background: #111827"] { padding: 60px 20px !important; }
  section[style*="background: #111827"] h1 { font-size: clamp(28px, 8vw, 48px) !important; }
  ...
  div[style*="padding: 25px"] { padding: 18px !important; }
